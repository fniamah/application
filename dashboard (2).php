...
$regen = "SELECT stdid, program FROM students WHERE status = 'Active'";
$regenrun = $conn->query($dbcon, $regen);
$count = 0;
$ddate = date("Y-m-d");
while($data = $conn->fetch($regenrun)){
    //GENERTAE THE NEW INVOICES
    $count++;
    $cid = $data['program'];
    $stdid = $data['stdid'];
	
	echo $insexams = "INSERT INTO std_exams (sbjid, stdid,status)SELECT sbjid, '$stdid', 'Pending' FROM sbj_course WHERE cid = '$cid'";
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <?php }elseif (isset($_GET['students_graduate'])){
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            <li><i class="icon-user position-left"></i> Students Management</li>
                            <li class="maincolor"><i class="icon-users position-left"></i> Graduated Students</li>
                        </ul>
        ...
        <?php }elseif (isset($_GET['exams_record'])){
            $dstdid = $_GET['exams_record'];
            $selstf = "SELECT e.id, e.stdid, e.sbjid, e.exam_score, s.fname, s.lname, s.program, s.img, s.contact, s.email FROM std_exams e INNER JOIN students s ON e.stdid = s.stdid WHERE e.stdid = '$dstdid' AND e.status = 'Pending'";
            $selstfrun = $conn->query($dbcon,$selstf);
            $dseldata = $conn->fetch($selstfrun);
            ?>
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <div class="page-header-content">
                        <div class="row" style="padding: 1%;">
                            ...
                            <div class="col-md-10 content-group" align="left">
                                <img src="<?php echo $dseldata['img']; ?>" class="content-group mt-10 img-rounded" alt="" style="width: 120px;">
                            </div>
                            <div class="col-md-2 content-group" align="left">
                                <ul class="list-condensed list-unstyled">
                                    <li><?php echo $dstdid; ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="breadcrumb-line">
                        <p style="text-align: center; font-weight: bolder; font-size: xx-large"><?php echo $dseldata['fname']." ".$dseldata['lname']; ?> Examination Records</p>
                    </div>
                </div>
                <!-- /page header -->
