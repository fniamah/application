...
$(function() {    
    ...
    function trafficSources(element, height) {
        ...
        d3.csv("assets/demo_data/dashboard/traffic_sources.php", function (error, data) {
  ...
  //SalesLines('#app_sales', 255); // initialize chart
    ...
    //nthlySalesArea("#monthly-sales-stats", 100, '#4DB6AC'); // initialize chart
